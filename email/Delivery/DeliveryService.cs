...
namespace email.Delivery
{
    ...
    public class DeliveryService : IDisposable
    {
        ...
        public DeliveryService(IEmailService service, IDeliveryConfiguration config)
        {
            _service = service;
            _config = config;
        ...
        public void Start()
        {
            ...
            var options = new ParallelOptions { MaxDegreeOfParallelism = _config.MaxDegreeOfParallelism.HasValue ? _config.MaxDegreeOfParallelism.Value : 10, CancellationToken = _cancel.Token };
